...
export default function App() {
  ...
  const persistUsers = (next: TeamUser[]) => { setUsers(next); void sharedSet(USERS_KEY, next); };
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-6 space-y-6">
            ...
            <div className="glass-soft rounded-[24px] p-6">
              <p className="text-[13px] font-semibold text-white/80 leading-relaxed">Roster, code, checklists, and logs all live in shared storage — changes here reach every device within seconds. The code is a team convenience gate, not server-grade security.</p>
            </div>
          </div>
        </div>
      )}
